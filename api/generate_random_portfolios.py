...
def fetch_snp_tickers(output_file=None):
...
def load_tickers_from_file(
    file_path=r"C:\Projects\school\Licenta\api\stock_tickers.txt",
):
...
if __name__ == "__main__":
    # Save S&P500 tickers to a text file
    # fetch_snp_tickers(output_file="stock_tickers.txt")
